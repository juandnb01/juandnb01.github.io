<?php
  ...
  include('includes/header2.php');
    ...
    if(isset($_POST['buscar']))
    {
      ...
      $consulta_cliente = "select * from arreglos inner join clientes on doc_cli = doc_cliente where id = '$buscar' and estado = 'entregado'";
...
<main class="container p-12">
    <div class="row">
    <div class="col-md-12">
      <h1>Reimprimir factura de entrega</h1>
    </div>
  </div>
</main>
    ...
    <div class="col-md-5">
      <h3>Ingrese el número de ticket</h3>
        <table>
          <tr>
            <td>
              <form class="form-inline my-2 my-lg-0" action="reim_fac_entrega.php" method="POST">
                ...
                <button class="btn btn-primary my-2 my-sm-0" type="submit" name="buscar" id="buscar">Buscar</button>&nbsp;
                 <a href="reim_fac_entrega.php"><input type="button" class="btn btn-primary my-2 my-sm-0" name="limpiar" id="limpiar" value="Limpiar"></a>
              </form>
            </td>
          </tr>
        </table>
...
{ ?>
    <div class="col-md-4">
        <h3>Cliente</h3>
        <input type="text" class="form-control" value="<?php echo $mostrar['nom_cliente']; echo " "; echo $mostrar['ape_cliente']; echo " - Ticket: "; echo $mostrar['id'];?>" readonly="readonly">
    </div>

    <div class="col-md-3">
      <br><br>
      <a href="ticket_venta_final.php?id=<?php echo $mostrar['id']?>" class="btn btn-primary my-2 my-sm-0" target="_blank">Reimprimir</a>
    </div>
</main>
